                    ...
                    <div className="mt-4 space-y-4 border-t border-slate-200 pt-4">
                      ...
                      <div className="grid gap-2">
                        ...
                        {member.membership_status === 'APPROVED' && (
                          <button
                            onClick={() => handleUpdateStatus(member.id, 'EXPIRED')}
                            className="w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 text-sm font-semibold text-slate-700 hover:border-slate-300 hover:bg-slate-50 transition"
                          >
                            <span className="flex items-center justify-center gap-2">
                      ...
                      <td className="px-3 py-3">
                        <div className="flex items-center gap-2">
                          <div className="w-7 h-7 rounded-full bg-blue-100 flex items-center justify-center shrink-0">
                            <span className="text-[10px] font-bold text-blue-700">{memberName.trim().charAt(0) || '?'}</span>
                          </div>
                      ...
                      <td className="px-3 py-3 text-right">
                        <div className="flex items-center justify-end gap-1.5 opacity-0 group-hover:opacity-100 transition-opacity duration-150">
                          ...
                          {member.membership_status !== 'APPROVED' ? (
                            ...
                            <>
                              {/* approved: show Edit/Delete only (placeholders) */}
                              <button
                                type="button"
                                onClick={() => toast.info('Edit is not implemented yet.')}
                                className="rounded-full bg-slate-50 p-1.5 text-slate-700 hover:bg-slate-100 border border-slate-200 transition"
                                title="Edit"
                              >
                              ...
                              <button
                                type="button"
                                onClick={() => toast.info('Delete is not implemented yet.')}
                                className="rounded-full bg-slate-50 p-1.5 text-slate-700 hover:bg-slate-100 border border-slate-200 transition"
                                title="Delete"
                              >
