...
export default function MilestoneDetail() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-start justify-center p-6" style={{ background: 'linear-gradient(180deg, #070E1B 0%, #030817 100%)' }}>
          ...
          <div className="mt-6 sm:mt-8">
            ...
            {milestone.source && (
              <a
                ...
                className="mt-3 inline-flex items-center gap-2 text-sm font-semibold transition-opacity duration-200 hover:opacity-80"
                style={{ color: cat.accent }}
              >
